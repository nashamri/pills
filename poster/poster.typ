...
#set text(font: "TeX Gyre Pagella", size: 24pt)
...
#let section-title(body) = block(
  ...
  #set text(size: 35pt, weight: "bold", fill: rgb("#80519e"))
  #align(center)[#body]
]
...
#grid(
  ...
  image("figuers/vision2030.svg", width: 10cm),
  image("figuers/logo.svg", width: 10cm),
  // Institutional text
  [
...
#grid(
  ...
  [
      #set text(size: 50pt, weight: "bold", font: "TeX Gyre Pagella")
